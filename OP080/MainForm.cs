...
using GT_Common.DriverForm.Twh;

namespace OP080
{
    public partial class MainForm : BaseMainForm
    {
        private TwhForm TwhForm;
        ...
        // 重写仪器仪表菜单，添加更多子项
        protected override ToolStripMenuItem CreateDriverMenu()
        {
            var menu = base.CreateDriverMenu();
            AddMenuItem(menu, "电阻焊监控仪", tsm_TwhFormClicked);
            return menu;
        }
        ...
        //  电阻焊监控仪器
        private void tsm_TwhFormClicked(object sender, EventArgs e)
        {

            if (TwhForm.IsDisposed)
                TwhForm = new TwhForm();
            TwhForm.Show();
        }
